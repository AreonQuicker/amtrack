...
namespace Amtrack.Data_V2.Data
{
	...
	public partial class AmtrackMainContext : DbContext
	{
		public AmtrackMainContext()
		{
		}

		public AmtrackMainContext(DbContextOptions<AmtrackMainContext> options)
			: base(options)
		{
		}
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
				optionsBuilder.UseSqlServer("server=10.37.0.36,1443;database=amtrack_v2;uid=support;pwd=F15HP@15T;Max Pool Size=300");
			}
		}
