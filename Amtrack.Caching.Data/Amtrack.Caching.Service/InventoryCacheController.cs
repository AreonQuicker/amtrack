    ...
    internal class InventoryCacheController
    {
        private class CacheDictionary<TKey, TValue> : Dictionary<TKey, TValue>
        {
            ...
            public static CacheDictionary<TKey, TValue> CreateDictionary(IEnumerable<TValue> values, Func<TValue, TKey> getKey, Func<TValue, TValue> getValue)
            {
                ...
                {
                    cacheDictionary.Add(getKey(value), getValue(value));
                }
        ...
        private Lazy<IEnumerable<stInventoryPricing>> _inventoryPricing = null;
        ...
        public InventoryCacheController(ICachingRepository cachingRepository)
        {
            ...
            _inventoryPricing = new Lazy<IEnumerable<stInventoryPricing>>(() => cachingRepository.stGetInventoryPricing());
        ...
        private InventoryPricingVO GetInventoryPricingVO(string itemCode)
        {
            ...
            {
                ItemCode = itemCode,
                Prices = _inventoryPricing.Value
        ...
        private InventoryItemVO GetInventoryItemVO(string itemCode)
        {
            ...
            return GetInventoryItemVO(catalugueItem);
        }

        private InventoryItemVO GetInventoryItemVO(stCatalogue catalugueItem)
        {
        ...
        public List<InventoryItemVO> GetInventoryItemVOs()
        {
            return _catalogueItems.Value
                ...
                .Select(s =>
                {
                    return GetInventoryItemVO(s.Value);
                })
                .ToList();
        }
